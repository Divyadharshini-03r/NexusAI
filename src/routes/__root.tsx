...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ask questions in plain English, get safe, optimized SQL, dashboards, and AI insights from your enterprise data." },
      { property: "og:title", content: "NexusIQ — Enterprise AI Data Intelligence" },
      { property: "og:description", content: "Natural language to SQL with safety, optimization, and interactive dashboards." },
